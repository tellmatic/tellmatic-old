...
$_MAIN_OUTPUT.="<br>".___("Geographische Verteilung der Anmeldungen");
if (file_exists($tm_reportpath."/map_earth_user_subscriptions.jpg")) {
	...
	$_MAIN_OUTPUT.="<br>".___("Karte wurde noch nicht erstellt.");
}

$_MAIN_OUTPUT.="<br><br>";

$_MAIN_OUTPUT.="<br>".___("Geographische Verteilung der Leser");
...
$_MAIN_OUTPUT.="<br>".___("Geographische Verteilung der Leser, Gewichtet");
