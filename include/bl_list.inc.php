...
if ($set=="aktiv") {
	if (!DEMO) $BLACKLIST->setAktiv($bl_id,$val);
	if ($val==1) {
...
require(TM_INCLUDEPATH."/pager.inc.php");
require_once(TM_INCLUDEPATH."/bl_list_legende.inc.php");
?>