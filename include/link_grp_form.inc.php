...
//add a Description
$Form->set_FormDesc($FormularName,___("Neue Gruppe erstellen / Gruppe bearbeiten"));//variable content aus menu als hidden field!
...
$_MAIN_OUTPUT.= tm_icon("textfield.png",___("Kürzel"))."&nbsp;".___("Kürzel");
$_MAIN_OUTPUT.= "</td>";
$_MAIN_OUTPUT.= "<td valign=top>";
