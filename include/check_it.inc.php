...
$_MAIN_DESCR=___("Prüfung manuell starten");

$_MAIN_OUTPUT.= "<strong>".___("Manuelle Prüfung")."</strong><br>";
...
if ($user_is_manager) {
	...
	if (!DEMO) $_MAIN_OUTPUT.="<br><br><em>*/10 * * * * /usr/bin/php-cli ".TM_INCLUDEPATH."/".$tmp_scriptname."</em>";
	###
