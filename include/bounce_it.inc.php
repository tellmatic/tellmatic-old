...
$_MAIN_DESCR=___("Automatisches Bouncemanagement manuell starten");

$_MAIN_OUTPUT.= "<strong>".___("Manuelle Ausführung des automatischen Bouncemanagements")."</strong><br>";
...
$_MAIN_OUTPUT.="<br><br>".___("Bevor Sie die Datei ausführen können, müssen Sie den exit; Befehl in der Datei  entfernen und die Einstellugen überprüfen.");
	...
	if (!DEMO) $_MAIN_OUTPUT.="<br><br>".sprintf(___("Der vollständige Pfad lautet: %s"),"<br><br><em>".TM_INCLUDEPATH."/tm_config.inc.php</em>");
	if (!DEMO) $_MAIN_OUTPUT.="<br><br>".___("Beispiel für einen Cronjob:");
	if (!DEMO) $_MAIN_OUTPUT.="<br><br><em>* */2 * * * /usr/bin/php-cli ".TM_INCLUDEPATH."/".$tmp_scriptname."</em>";
	###
